...
{
    public class ResetChildrenPasswordCommandValidator : AbstractValidator<ResetChildrenPasswordCommand>
    {
        public ResetChildrenPasswordCommandValidator()
        {
            ...
            RuleFor(x => x.ChildrenUserid)
                .NotEmpty().WithMessage("ChildrenUserid 不能为空")
