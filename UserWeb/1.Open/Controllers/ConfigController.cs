...
namespace Open.Controllers
{
    ...
    public async Task<IActionResult> GetConfigsAsync([FromBody] GetConfigsQuery query, CancellationToken ct)
     {
    ...
    public async Task<IActionResult> GetApiConfigsAsync([FromBody] GetApiConfigsQuery query, CancellationToken ct)
     {
